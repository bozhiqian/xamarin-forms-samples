...
/*
 The code, given below, is Date of birth validation Behaviors. I used a DatePicker and restricted the max date to be 100 years 
 from the current day and min date to be one.
 *
 */
